...
const RemedyUse =(props)=>(
    ...
    <h2 className='remedyUserText'>את התכשיר ההומאופתי יש לאחסן במקום שבו אין חשיפה לשום סוג של קרינה אשר גורמת לפירוק היעילות של התרופה ההומאופתית.
    קופסאות פח, או מתכת אחרת, כמו של שוקולד יתנו הגנה מסוג זה.
    ובמידה ואין לכם, אז ניתן לעטוף היטב בנייר כסף, אלומיניום, כזה שלכולנו יש במטבח.
    ...
    עוד נקודה חשובה בעניין זה, כאשר אתם אוספים את הרמדי ההומאופתי מבית המרקחת. תבקשו שיעטפו לכם בנייר כסף, ותקפידו לשים את הרמדי בנפרד מהסלולארי – שימו לב, לא לשים את שניהם יחד בתיק. אחרת, מלבד סוכריות טעימות, לא תהיה השפעה רבה.
